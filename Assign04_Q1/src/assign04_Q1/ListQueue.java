...
public class ListQueue<E> extends AbstractQueue<E>
    ...
    public boolean offer(E item) {
        ...
        if (front == null) {
            ...
            // Allocate a new node at end, store item in it, 
        	// and link it to old end of queue.
    ...
    private class Iter implements Iterator<E> {
       ...
       /**
        ...
        /**
         * Return the next item in the iteration and advance 
         * the iterator
         ...
         * @throws UnsupportedOperationException this operation 
         * is not supported
         */
        @Override
        public void remove() {
